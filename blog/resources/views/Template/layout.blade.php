        ...
        <nav class="light-green darken-4" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    @if (Auth::guest())
                    <li class="light-green darken-3"><a href="connexion" class="white-text"><img src="{{URL::asset('media/icons/fa-power.png')}}" style="margin-right: 10px">CONNEXION</a></li>
                    @else
                    <li class="light-green darken-3"><a href="logout" class="white-text"><img src="{{URL::asset('media/icons/fa-power.png')}}" style="margin-right: 10px">Logout</a></li>
                    @endif
                    <li class="light-green darken-3" style="margin-left: 5px"><a href="#" class="white-text"><img src="{{URL::asset('media/icons/fa-shopping-cart.png')}}" style="margin-right: 10px">MON PANIER</a></li>
                </ul>
                ...
                <ul class="side-nav" id="mobile-demo">
                    ...
                    <li class="light-green darken-3"><a href="connexion" class="white-text"><img src="{{URL::asset('media/icons/fa-power.png')}}" style="margin-right: 10px">CONNEXION</a></li>
                    @else
                    <li class="light-green darken-3"><a href="connexion" class="white-text"><img src="{{URL::asset('media/icons/fa-power.png')}}" style="margin-right: 10px">Logout</a></li>
                    @endif
                    <li class="light-green darken-3"><a href="#" class="white-text"><img src="{{URL::asset('media/icons/fa-shopping-cart.png')}}" style="margin-right: 10px">MON PANIER</a></li>
                </ul>
